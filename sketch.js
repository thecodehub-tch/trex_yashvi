...
var trex, ground, invisibleGround, trex_running, groundImage, trex_collided, obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6, score, cloudsGroup, obstaclesGroup;
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //set lifetime of the game objects so that it never disappears
